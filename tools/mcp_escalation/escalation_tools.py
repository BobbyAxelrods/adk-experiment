...
def _escalate_to_live_agent(reason: str = "User request", context: str = "", tool_context: Optional[ToolContext] = None) -> Dict[str, Any]:
    """
    ...
    Returns:
      A dict with ticket details.
    """
    return create_escalation_ticket(reason=reason, context=context, tool_context=tool_context)
